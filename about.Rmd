...
This website describes the project and meta-database 'Evidence for Risilient Agriculture' (ERA), through working with it's data found in the ERAg package version xx.xx.xx. The website is divided in three parts: Part 1 Introduction, Part 2: Agroforestry Analysis With ERAAnalyze and Part 3: Agroforestry Analysis With Tidymodels Machine Learning Start at Chapter 1 to get an overview of the package. Then feel free to browse the chapter for more information on topics you are interested in.
