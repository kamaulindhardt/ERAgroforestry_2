---
title: "Part 3: Agroforestry With Tidymodels"
...
above or below 3∗IQR (interquartile range) are removed.
...
ggdraw() + 
  draw_image(here::here("agfor_stacked_model_full_lares_plot_spatcv.png")) 
```
...
ggdraw() + 
  draw_image(here::here("agfor_stacked_model_linreg_lares_plot_spatcv.png")) 
```
...
ggdraw() + 
  draw_image(here::here("agfor_stacked_model_splits_lares_plot_spatcv.png")) 
```
...
ggdraw() + 
  draw_image(here::here("agfor_stacked_model_full_lares_plot_cv.png")) 
```
...
```{r eval=TRUE, layout="l-screen-inset shaded", code_folding=TRUE, fig.width=12, fig.height=6, fig.cap = "Full lares plot for the ensemble stacked model with normal cv-folds"}
ggdraw() + 
  draw_image(here::here("agfor_stacked_model_linreg_lares_plot_cv.png")) 
```
...
ggdraw() + 
  draw_image(here::here("agfor_stacked_model_splits_lares_plot_cv.png")) 
```
